...
const Logo = () => (
  <svg width="64" height="64" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <ellipse cx="50" cy="28" rx="15" ry="22" fill="url(#lg)" opacity="0.92" />
    <ellipse cx="72" cy="50" rx="15" ry="22" fill="url(#lg)" opacity="0.92" transform="rotate(90 72 50)" />
    <ellipse cx="50" cy="72" rx="15" ry="22" fill="url(#lg)" opacity="0.92" />
    <ellipse cx="28" cy="50" rx="15" ry="22" fill="url(#lg)" opacity="0.92" transform="rotate(90 28 50)" />
    <circle cx="50" cy="50" r="14" fill="url(#lg)" />
  </svg>
);
        ...
        <div style={{
          ...
          <div style={{ textAlign: "center", marginBottom: 28 }}>
            ...
            <p style={{ fontSize: 14, color: "#888888" }}>
              ...
              <Link href="/signup" style={{ color: "#4CAF8C", fontWeight: 600, textDecoration: "underline" }}>
                Sign up
              </Link>
            </p>
          </div>
